...
function create_default_slot$1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			const layout_context_changes = {};
			if (dirty & /*context_values*/ 4) layout_context_changes.context_style = /*func*/ ctx[8];
...
function create_fragment$2(ctx) {
	...
	function element_1_ref_binding(value) {
		/*element_1_ref_binding*/ ctx[9].call(null, value);
	}
	...
	return {
		...
		p(ctx, [dirty]) {
			const element_1_changes = (dirty & /*layout_x_style, $$props, style, element_props*/ 26)
			...
			if (dirty & /*$$scope, context_values*/ 1028) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*height, width*/ 96) {
			 $$invalidate(2, context_values = { height, width });
		}
...
class Box extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { ref: 0, style: 1 });
	}
}
...
var css_248z$2 = ".image_i1b6qkac > img{display:block;object-fit:cover;}\n";
...
exports.format_length_property = format_length_property;
exports.grow = grow;
exports.length_defaults = length_defaults;
exports.max = max;
exports.min = min;
exports.px = px;
exports.ratio = ratio;
